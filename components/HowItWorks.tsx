...
export default function HowItWorks({ onNavigate }: HowItWorksProps) {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sí. Al final del año fiscal, recibirás un certificado de donación por el total aportado, deducible hasta un 80% en los primeros 150€ según la legislación española vigente."
    }
  ];
